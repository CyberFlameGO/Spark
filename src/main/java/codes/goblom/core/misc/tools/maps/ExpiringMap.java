...
public class ExpiringMap<K, V> implements Map<K, V> {
    ...
    protected ExpiringMap(Builder builder) {
        ...
        if (builder.expirationListeners != null) {
            expirationListeners = new CopyOnWriteArrayList<ExpirationListenerConfig<K, V>>((List) builder.expirationListeners);
        }
     ...
     * iterating, excluding calls to (Iterator{@link #remove(Object)}.
     */
